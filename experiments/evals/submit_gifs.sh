...
cd /n/holyscratch01/ba_lab/Users/mjacobs/mit67900_final_project/experiments/evals/
...
# SAVE RESULTS
rsync -avx results/gifs/ ~/mit67900_final_project/experiments/evals/results/gifs/