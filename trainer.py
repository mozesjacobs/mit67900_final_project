...
def train(agent, env, fpath, total_time=1000000, run_length=1000, window_length=100, eps=1.0, eps_end=0.01, eps_decay=0.995, return_pos_r=False):
    """Deep Q-Learning.
    ...
    pos_rewards = [] # list containing number of positive rewards for each run
